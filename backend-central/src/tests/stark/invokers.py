...
async def main():
    ...
    #     buyer=int("0x40dc3bb58168d641811d5a516760c9ba57ee7bf98c547fa3fb5fce71774d90b", 16),
    #     amount=1,
    #     auto_estimate=True
    # )
    # print("Transaction hash:", hex(invocation.hash))  # Safe to print here
    
    # invocation = await contract.functions["consume"].invoke_v3(
    #     account=int("0x40dc3bb58168d641811d5a516760c9ba57ee7bf98c547fa3fb5fce71774d90b", 16),
    #     amount=1,
    #     auto_estimate=True
    # )
    # print("Transaction hash:", hex(invocation.hash))  # Safe to print here
    ...
    #     reciepient=int("0x074de4a707539c4d01dd3d0e92c7a56c6974d2b8d5626f17deca161a32def42e", 16),
    #     amount=2,
    #     auto_estimate=True
    # )
    # print("Transaction hash:", hex(invocation.hash))  # Safe to print here

    invocation = await contract.functions["mint"].invoke_v3(
        account=int("0x40dc3bb58168d641811d5a516760c9ba57ee7bf98c547fa3fb5fce71774d90b", 16),
        amount=100,
        auto_estimate=True
    )
