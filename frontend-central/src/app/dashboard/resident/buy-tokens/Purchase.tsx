...
const isToday = (dateStr: string) => {
  ...
  const givenLocal = new Date(
    givenDate.toLocaleString('en-KE', { timeZone: 'Africa/Nairobi' })
  );
  ...
  return (
    givenLocal.getDate() === nowLocal.getDate() &&
    givenLocal.getMonth() === nowLocal.getMonth() &&
    givenLocal.getFullYear() === nowLocal.getFullYear()
  );
};
